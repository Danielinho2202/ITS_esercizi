'''Scrivere una funzione ricorsiva recursiveDigitCounter che restituisca il numero di cifre di un numero intero n 
passato in input.
...
dunque, dividere n per 10 per rimuovere l'ultima cifra e richiama ricorsivamente la funzione, fino a ottenere un numero 
con una sola cifra.'''

def recursiveDigitCounter(n:float):
    if n==0:
        return 1
    if abs(n)<10:
        return 1
...
print (recursiveDigitCounter(1.45))
print (recursiveDigitCounter(-572336))